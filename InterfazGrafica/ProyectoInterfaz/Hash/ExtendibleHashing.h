...
#include <iostream>
#include <cmath>
#include </Users/christianledgard/Downloads/stdc++.h>
#include <cstdio>
#include "Bucket.h"
...
//     remove("temp.dat");
//     remove("test.dat");
//     ExtendibleHash<RecordHash<long>> hash(1,3,"test.dat");
//     hash.insertRecord(RecordHash<long>(16));
//     hash.insertRecord(RecordHash<long>(4));
//     hash.insertRecord(RecordHash<long>(6));
//     hash.insertRecord(RecordHash<long>(22));
//     hash.insertRecord(RecordHash<long>(24));
//     hash.insertRecord(RecordHash<long>(10));
//     hash.insertRecord(RecordHash<long>(31));
//     hash.insertRecord(RecordHash<long>(7));
//     hash.insertRecord(RecordHash<long>(9));
//     hash.insertRecord(RecordHash<long>(20));
//     hash.insertRecord(RecordHash<long>(26));
//     return 0;
// }
